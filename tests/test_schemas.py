...
class TestToCamelCase:
    ...
    def test_to_camel_case_conversion(self, snake_case, expected_camel_case):
...
class TestCamelCaseDictFactory:
    """Test camel_case_dict_factory function."""

    def test_dict_factory_converts_keys(self):
    ...
    def test_dict_factory_omits_none_values(self):
    ...
    def test_dict_factory_empty_fields(self):
        """Test dict factory with empty fields list."""
        result = camel_case_dict_factory([])

        assert result == {}

    def test_dict_factory_preserves_value_types(self):
...
class TestDataclassToDict:
    ...
    def test_list_of_dataclasses_conversion(self):
    ...
    def test_enum_fields_serialization(self):
